              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    ...
                    style={{
                      width: '100%', padding: '12px 44px 12px 16px', border: `2px solid ${errors.password ? '#ef4444' : border}`,
                      borderRadius: 12, fontSize: 14, fontFamily: 'inherit', direction: 'ltr', textAlign: 'right',
                      outline: 'none', background: surface, color: 'var(--color-text)'
                    }}
                  />
                ...
                {form.password && (
                  <div style={{ marginTop: 8 }}>
                    <div style={{
                      ...
                      background: dm ? 'var(--color-border)' : '#e2e8f0', overflow: 'hidden'
                    }}>
                      <div style={{
                    ...
                    <span style={{ fontSize: 11, color: getPasswordStrength(form.password).color, marginTop: 4, display: 'block' }}>
